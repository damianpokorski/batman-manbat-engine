...
namespace Manbat
{
    ...
    void BoneMesh::Render( Manbat::Effect* effect ) 
    {
        if (p_frameRoot)
    ...
    void BoneMesh::drawFrame(LPD3DXFRAME frame, Manbat::Effect* effect ) 
    {
    ...
    void BoneMesh::drawMeshContainer(LPD3DXMESHCONTAINER meshContainerBase, 
        LPD3DXFRAME frameBase,  Manbat::Effect* effect)
    {
...
void MeshLoaderCallback::splitPath(std::string* inputPath, std::string* pathOnly, std::string* filenameOnly)
{
